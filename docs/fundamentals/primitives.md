...
agentic composition. See [DESIGN-layout-affinity.md](../decisions/layout-affinity.md)
...
[PRODUCT-PAGE-PATTERNS.md](../patterns/product-page-patterns.md). Those recipes show how
...
[MEDIA-SITE-PATTERNS.md](../patterns/media-site-patterns.md). Those recipes show how to
...
[FORUM-SITE-PATTERNS.md](../patterns/forum-site-patterns.md). Those recipes show how to
