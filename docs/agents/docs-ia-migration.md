...
| `site/content/docs/components/all.md` | Components | `src/chirp_ui/manifest.json` | Generated by `scripts/build_component_index.py`; do not hand-edit the block between the splice markers. Drift-guarded by `tests/docs_contracts/test_onsite_component_coverage.py`. |
