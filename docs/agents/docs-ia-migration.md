...
| `site/content/docs/components/controls.md` | Components | `docs/components/control-selection.md`, `docs/components/dropdown-anatomy.md`, `src/chirp_ui/templates/chirpui/forms.html` | Keep as the published decision guide for native controls, dropdown-select, toggle groups, sliders, and composed data tables. |
...
| `site/content/docs/reference/_index.md` | Integrations | `src/bengal_themes/chirp_theme/templates/shortcodes/`, `src/bengal_themes/chirp_theme/templates/directives/` | Keep as the on-site index for the chirp-theme authoring vocabulary; cite theme template sources rather than inventing reference facts. |
| `site/content/docs/reference/directives.md` | Integrations | `src/bengal_themes/chirp_theme/templates/directives/` | Keep directive options and rendered examples in sync with the packaged directive templates. |
| `site/content/docs/reference/shortcodes.md` | Integrations | `src/bengal_themes/chirp_theme/templates/shortcodes/` | Keep shortcode parameters and rendered examples in sync with the packaged shortcode templates. |
