...
- **Shipping a utility class vocabulary.** Explicitly rejected in `docs/strategy/vision.md § What we are not`.
...
- `docs/strategy/vision.md § CSS architecture as a registry projection` — the *why*
