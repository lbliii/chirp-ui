...
- [PROMOTION-LEDGER.md](screens/promotion-ledger.md) — Screen-pattern promotion ladder, candidate evidence, and stop-and-ask boundary
...
- [DESIGN-typography-role-matrix.md](decisions/typography-role-matrix.md) — Recipe-only typography audit matrix for golden-screen role mapping
