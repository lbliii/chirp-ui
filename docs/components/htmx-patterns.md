...
See [SEARCH-SHELL-RECIPES.md](../patterns/search-shell-recipes.md) for the full catalog
...
- [SEARCH-SHELL-RECIPES.md](../patterns/search-shell-recipes.md) — Dense catalog/search shell progressive enhancement contracts
- [HTMX-ADVANCEMENT.md](../decisions/htmx-advancement.md) — Design decisions for htmx integration
- [ANTI-FOOTGUNS.md](../safety/anti-footguns.md) — Common htmx pitfalls and how chirp-ui prevents them
