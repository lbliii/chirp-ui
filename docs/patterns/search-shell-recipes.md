...
- Recipe-level layout affinity may be used to make command surfaces
  ...
  `pressure=rigid`. See [DESIGN-layout-affinity.md](../decisions/layout-affinity.md).
...
[DESIGN-layout-affinity.md](../decisions/layout-affinity.md). This search-shell guide
