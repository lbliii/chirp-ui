...
COMPONENTS: dict[str, ComponentDescriptor] = {
    ...
    "chat-input": ComponentDescriptor(
        ...
        maturity="experimental",
        macro="composer",
        extra_emits=("composer__send", "composer__stop", "composer__attachments", "composer__suggestions", "composer__file", "composer__field", "composer--dragover", "composer__drop-overlay"),
    ),
