...
COMPONENTS: dict[str, ComponentDescriptor] = {
    ...
    "dropdown-select": ComponentDescriptor(
        block="dropdown",
        modifiers=("select",),
        elements=("trigger", "selected", "caret", "menu", "item"),
    ...
    "context-menu": ComponentDescriptor(
        block="context-menu",
        elements=("target", "panel"),
        slots=("",),
        template="context_menu.html",
        extra_emits=("chirpui-context-menu__icon",),
        category="navigation",
        maturity="stable",
        requires=("alpine",),
        macro="context_menu",
    ),
    "context-menu__item": ComponentDescriptor(
        block="context-menu__item",
        variants=("default", "danger", "muted"),
        slots=("",),
        template="context_menu.html",
        trim_emits=("chirpui-context-menu__item--default",),
        category="navigation",
        maturity="stable",
        macro="context_menu",
    ),
    "input-otp": ComponentDescriptor(
        block="input-otp",
        elements=("label", "group", "cell"),
        template="input_otp.html",
        category="form",
        maturity="stable",
        requires=("alpine",),
        macro="input_otp",
    ...
    "menubar": ComponentDescriptor(
        block="menubar",
        elements=("root", "trigger", "menu", "item", "icon"),
        template="menubar.html",
        extra_emits=("chirpui-menubar__icon",),
        category="navigation",
        maturity="stable",
        requires=("alpine",),
        macro="menubar",
    ),
    "menubar__item": ComponentDescriptor(
        block="menubar__item",
        variants=("default", "danger", "muted"),
        template="menubar.html",
        trim_emits=("chirpui-menubar__item--default",),
        category="navigation",
        maturity="stable",
        macro="menubar",
    ),
    "navigation-menu": ComponentDescriptor(
        block="navigation-menu",
        elements=("list", "item", "trigger", "panel", "link", "caret", "link-label", "link-desc"),
        template="navigation_menu.html",
        modifiers=("has-children",),
        extra_emits=("chirpui-navigation-menu__link--top",),
        category="navigation",
        maturity="experimental",
        requires=("alpine",),
    ...
    "date-picker": ComponentDescriptor(
        block="date-picker",
        modifiers=("range",),
        elements=(
            "label",
    ...
    "message-actions": ComponentDescriptor(
        block="message-actions",
        modifiers=("last",),
        template="message_actions.html",
        category="layout",
        maturity="stable",
        macro="message_actions",
        requires=("alpine",),
    ),
    "message-meta": ComponentDescriptor(
        block="message-meta",
        elements=("model", "time", "usage", "usage-detail"),
        template="message_meta.html",
        category="layout",
        maturity="stable",
        macro="message_meta",
    ),
    "reasoning": ComponentDescriptor(
        block="reasoning",
        modifiers=("pending",),
        elements=("shimmer",),
    ...
    "tool-call": ComponentDescriptor(
        block="tool-call",
        variants=("pending", "running", "done", "error"),
        elements=("status", "result", "files", "file"),
        template="reasoning.html",
        category="layout",
        maturity="stable",
    ...
    "shortcuts-help": ComponentDescriptor(
        block="shortcuts-help",
        elements=(
            "inner",
            "header",
            "title",
    ...
    "separator": ComponentDescriptor(
        block="separator",
        modifiers=("horizontal", "vertical", "decorative"),
        template="separator.html",
        elements=("label",),
        category="layout",
        role="component",
        maturity="stable",
    ),
    "aspect-ratio": ComponentDescriptor(
        block="aspect-ratio",
        template="aspect_ratio.html",
        elements=("inner",),
        slots=("",),
        category="layout",
        role="component",
    ...
    "label": ComponentDescriptor(
        block="label",
        template="label.html",
        elements=("text", "required", "hint"),
        category="form",
        role="component",
        maturity="stable",
        macro="ui_label",
    ...
    "toggle-group": ComponentDescriptor(
        block="toggle-group",
        sizes=("", "sm", "lg"),
        modifiers=("single", "multiple", "horizontal", "vertical", "outline"),
        template="toggle_group.html",
        elements=("input", "item", "label", "icon"),
        extra_emits=(
    ...
    "slider": ComponentDescriptor(
        block="slider",
        sizes=("", "sm", "lg"),
        modifiers=("disabled",),
        template="slider.html",
        elements=("header", "label", "value", "input"),
        category="control",
        role="component",
        maturity="stable",
    ),
    "scroll-area": ComponentDescriptor(
        block="scroll-area",
        modifiers=("vertical", "horizontal", "both", "fade"),
        template="scroll_area.html",
        elements=("viewport",),
        slots=("",),
        category="layout",
        role="component",
    ...
    "item": ComponentDescriptor(
        block="item",
        modifiers=("selected", "disabled"),
        template="item.html",
        elements=("icon", "content", "title", "description", "meta", "action"),
        slots=("action",),
        category="content",
        role="component",
        maturity="stable",
    ),
    "data-table": ComponentDescriptor(
        block="data-table",
        modifiers=("compact",),
    ...
    "filter-rail": ComponentDescriptor(
        block="filter-rail",
        elements=("list", "item", "mark", "body", "label", "meta", "count"),
        slots=("",),
        template="workspace_primitives.html",
        category="navigation",
        maturity="experimental",
        role="pattern",
    ),
    "metric-strip": ComponentDescriptor(
        block="metric-strip",
        elements=("item", "value", "label"),
        slots=("",),
        template="workspace_primitives.html",
        category="data-display",
        maturity="experimental",
    ...
    "result-collection": ComponentDescriptor(
        block="result-collection",
        elements=("header", "title", "meta", "items"),
        slots=("", "meta"),
        template="workspace_primitives.html",
        category="data-display",
        maturity="experimental",
    ...
    "result-card": ComponentDescriptor(
        block="result-card",
        elements=(
            "header",
            "mark",
        ...
        slots=("", "mark", "actions", "footer"),
        template="workspace_primitives.html",
        category="data-display",
        maturity="experimental",
        role="pattern",
    ),
    "inspector-panel": ComponentDescriptor(
    ...
    "param": ComponentDescriptor(
        block="param",
        elements=("head", "label", "mode", "mode-opt", "default-val", "custom"),
    ...
    "scope-indicator": ComponentDescriptor(
        block="scope-indicator",
        modifiers=("override",),
        elements=("dot",),
        template="param_override.html",
        category="form",
    ...
    "chat-input": ComponentDescriptor(
        ...
        modifiers=("dock",),
        slots=("attachments", "suggestions", "footer"),
        template="chat_input.html",
        category="form",
        maturity="experimental",
        macro="composer",
        extra_emits=(
            "chirpui-composer__send",
            "chirpui-composer__stop",
            "chirpui-composer__attachments",
            "chirpui-composer__suggestions",
            "chirpui-composer__file",
            "chirpui-composer__field",
            "chirpui-composer__file-input--visible",
            "chirpui-composer--dragover",
            "chirpui-composer__drop-overlay",
        ),
    ),
    "attachment-chip": ComponentDescriptor(
        block="attachment-chip",
        variants=("uploading", "processing", "ready", "error"),
        elements=("icon", "name", "size", "dismiss"),
        modifiers=("row",),
    ...
    "follow-ups": ComponentDescriptor(
        block="follow-ups",
        elements=(),
        template="follow_ups.html",
        category="form",
        maturity="experimental",
        macro="suggestion_chips",
        extra_emits=("chirpui-chip--suggestion",),
    ),
