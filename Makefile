...
.PHONY: all help setup install test test-js test-cov test-browser pre-pr lint lint-fix format ty clean shell build publish release gh-release release-preflight
