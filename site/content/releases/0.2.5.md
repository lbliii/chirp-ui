...
- **Shell tabs contract** — New `docs/components/shell-tabs-contract.md` documenting shell-region tab ownership rules. `route_tabs` now accepts dict-shape `tab_items` in addition to the existing list shape.
