...
### Bengal theme package

Packaged `bengal_themes.chirp_theme` with standalone CSS, templates, and assets --- registered as `chirp-theme` entry point for Bengal's theme registry.
